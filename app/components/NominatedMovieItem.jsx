        ...
        return (
          ...
          >
            <div className="flex ">
              ...
              {movie.detailedMovie && (
                <div className="flex flex-col justify-between md:pl-4 pt-4 px-1 my-4 leading-normal text-[#675621] font-bold">
                  <h3 className="mt-0 tracing-tight text-center md:text-left font-extrabold">
